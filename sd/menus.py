...
class MenuMaker:
    ...
    def context_menu(self):
        ...
        menu_items = [
                ...
                { "label": "Polygon      [p]",          "callback": self.on_menu_item_activated, "action": "mode_polygon" },
                ...
                { "label": "Screenshot      (Ctrl-F)",  "callback": self.on_menu_item_activated, "action": "screenshot" },
    ...
    def object_menu(self, objects):
        ...
        menu_items = [
                ...
                { "separator": True },
                { "label": "To polygon (Alt-p)",   "callback": self.on_menu_item_activated, "action": "transmute_to_polygon" },
                { "label": "To drawing (Alt-P)",   "callback": self.on_menu_item_activated, "action": "transmute_to_drawing" },
